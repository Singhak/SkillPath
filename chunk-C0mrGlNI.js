import {R as Re}from'./chunk-CICgB45p.js';import {d as dt$1,U as Ut$1}from'./chunk-Cu65x8G6.js';import {ad as ZI,ae as bs,af as Pe,ag as Y,I,aB as C,ah as R,ar as dy,z as zI,f as fe,ay as th,aT as Pu,T as Ti,l as lh,U as Uc,u as lw,bg as Ch,o as ch,p as pE,aO as ah,X as Nw,aC as he,aD as rD,bJ as Vr,aK as ML,ai as Le,x as Ho,$ as Qw,bw as ft$1,bK as Ie,aq as ec,aS as mt$1,bL as Du,bM as Kt$1,bH as Ou,bN as Ge$1,bB as Ke,bi as Ar,bO as qu,ak as se,as as Uo,at as zi,au as In$1,av as Pn,aw as On$1,bP as Zr,P as hr,aL as $r,bQ as Ar$1,bR as L,bS as Mr,ax as Ue,bs as _r,az as kL,aA as OL,k as kD,m as rh,a5 as jh,D as Du$1,a6 as ww,c as wu,g as gh,a$ as qw,a8 as Fh,bT as $e,b0 as aw,aE as vh,aF as GD,aG as WD,aH as yh,h as cr,bU as Xr,al as oo,bV as xn$1,aJ as H,e as ee,H as HD,b4 as Wc,b5 as zc,E as Ew,Q as Qc,bu as Io,b1 as xw,b6 as fh,b3 as QD,bq as Aw,br as Sw,b9 as Rw,n as Oh}from'./main-VBO7PQ3C.js';var Ge=`
    .p-progressspinner {
        position: relative;
        margin: 0 auto;
        width: 100px;
...
`;var lt={root:()=>["p-progressspinner"],spin:"p-progressspinner-spin",circle:"p-progressspinner-circle"},je=(()=>{class n extends H{name="progressspinner";style=Ge;classes=lt;static \u0275fac=(()=>{let e;return function(i){return (e||(e=dy(n)))(i||n)}})();static \u0275prov=ee({token:n,factory:n.\u0275fac})}return n})();var We=new C("PROGRESSSPINNER_INSTANCE"),at=(()=>{class n extends Y{componentName="ProgressSpinner";$pcProgressSpinner=I(We,{optional:true,skipSelf:true})??void 0;bindDirectiveInstance=I(R,{self:true});styleClass;strokeWidth="2";fill="none";animationDuration="2s";ariaLabel;onAfterViewChecked(){this.bindDirectiveInstance.setAttrs(this.ptms(["host","root"]));}_componentStyle=I(je);static \u0275fac=(()=>{let e;return function(i){return (e||(e=dy(n)))(i||n)}})();static \u0275cmp=zI({type:n,selectors:[["p-progressSpinner"],["p-progress-spinner"],["p-progressspinner"]],hostVars:5,hostBindings:function(t,i){t&2&&(ah("aria-label",i.ariaLabel)("role","progressbar")("aria-busy",true),lw(i.cn(i.cx("root"),i.styleClass)));},inputs:{styleClass:"styleClass",strokeWidth:"strokeWidth",fill:"fill",animationDuration:"animationDuration",ariaLabel:"ariaLabel"},features:[Nw([je,{provide:We,useExisting:n},{provide:he,useExisting:n}]),rD([R]),th],decls:2,vars:10,consts:[["viewBox","25 25 50 50",3,"pBind"],["cx","50","cy","50","r","20","stroke-miterlimit","10",3,"pBind"]],template:function(t,i){t&1&&(Pu(),Ti(0,"svg",0),lh(1,"circle",1),Uc()),t&2&&(lw(i.cx("spin")),Ch("animation-duration",i.animationDuration),ch("pBind",i.ptm("spin")),pE(),lw(i.cx("circle")),ch("pBind",i.ptm("circle")),ah("fill",i.fill)("stroke-width",i.strokeWidth));},dependencies:[fe,Pe,R],encapsulation:2})}return n})(),Qn=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=ZI({type:n});static \u0275inj=bs({imports:[at,Pe,Pe]})}return n})();var Je=class n{apiUrl=`${Xr.apiUrl}`;http=I(oo);generateEvaluation(l){return this.http.post(`${this.apiUrl}/ai-evaluations`,l)}generateMockEvaluation(l){return this.http.post(`${this.apiUrl}/ai-evaluations/mock-evaluation`,l)}genrateFromTopic(l,e,t,i){return this.http.post(`${this.apiUrl}/ai-question-sets/from-topic`,{topic:l,userRole:e,experienceLevel:t,questionCount:i})}generateFromJobDescription(l,e,t,i){return this.http.post(`${this.apiUrl}/ai-question-sets/from-job-description`,{jobDescription:l,userRole:e,experienceLevel:t,questionCount:i})}getAiGeneratedQuestion(l,e){return this.http.get(`${this.apiUrl}/ai-questions`,{params:{type:l,level:e}})}static \u0275fac=function(e){return new(e||n)};static \u0275prov=xn$1({token:n,factory:n.\u0275fac})};var Zn=["Frontend Developer","Backend Developer","Full-Stack Developer","Mobile Developer","Software Architect","UI/UX Designer","Project Manager","Scrum Master","Product Owner","QA Engineer","DevOps Engineer","Support Engineer","Security Engineer","Data Engineer","ML/AI Engineer"],Jn=["Intern","Junior","Mid-Level","Senior","Lead","Principal","Architect"],Xn=["Explain concepts clearly","Give practical examples","Mention trade-offs","Speak confidently"],Yn=["Extract Required Skills","Generate Technical Questions","Behavioral Questions","Coding Questions","Difficulty Detection"];function ei(n,l){let e=document.createElement("a");return e.setAttribute("href",n),e.setAttribute("download",l),document.body.appendChild(e),e}function ti(n){switch(n=n?.toLowerCase()?.trim(),n){case "basic":return 1;case "intermediate":return 1.5;case "advanced":return 2;case "critical concept":return 3;default:return ""}}var ni={QUESTION_EVALUATION:.25};var Xe=`
    .p-autocomplete {
        display: inline-flex;
    }
...
`;var rt=["item"],pt=["empty"],st=["header"],ct=["footer"],ut=["selecteditem"],dt=["group"],mt=["loader"],ht=["removeicon"],_t=["loadingicon"],gt=["clearicon"],ft=["dropdownicon"],yt=["focusInput"],xt=["multiIn"],bt=["multiContainer"],vt=["ddBtn"],It=["items"],wt=["scroller"],Ct=["overlay"],Ot=n=>({i:n}),tt=n=>({$implicit:n}),Tt=(n,l,e)=>({removeCallback:n,index:l,class:e}),le=n=>({height:n}),nt=(n,l)=>({$implicit:n,options:l}),St=n=>({options:n}),Et=()=>({}),Vt=(n,l,e)=>({option:n,i:l,scrollerOptions:e}),kt=(n,l)=>({$implicit:n,index:l});function Mt(n,l){if(n&1){let e=kD();Ti(0,"input",18,2),gh("input",function(i){Du$1(e);let o=HD();return wu(o.onInput(i))})("keydown",function(i){Du$1(e);let o=HD();return wu(o.onKeyDown(i))})("change",function(i){Du$1(e);let o=HD();return wu(o.onInputChange(i))})("focus",function(i){Du$1(e);let o=HD();return wu(o.onInputFocus(i))})("blur",function(i){Du$1(e);let o=HD();return wu(o.onInputBlur(i))})("paste",function(i){Du$1(e);let o=HD();return wu(o.onInputPaste(i))})("keyup",function(i){Du$1(e);let o=HD();return wu(o.onInputKeyUp(i))}),Uc();}if(n&2){let e=HD();lw(e.cn(e.cx("pcInputText"),e.inputStyleClass)),ch("pAutoFocus",e.autofocus)("pt",e.ptm("pcInputText"))("ngStyle",e.inputStyle)("variant",e.$variant())("invalid",e.invalid())("pSize",e.size())("fluid",e.hasFluid)("pInputTextUnstyled",e.unstyled()),ah("type",e.type)("value",e.inputValue())("id",e.inputId)("autocomplete",e.autocomplete)("placeholder",e.placeholder)("name",e.name())("minlength",e.minlength())("min",e.min())("max",e.max())("pattern",e.pattern())("size",e.inputSize())("maxlength",e.maxlength())("tabindex",e.$disabled()?-1:e.tabindex)("required",e.required()?"":void 0)("readonly",e.readonly?"":void 0)("disabled",e.$disabled()?"":void 0)("aria-label",e.ariaLabel)("aria-labelledby",e.ariaLabelledBy)("aria-required",e.required())("aria-expanded",e.overlayVisible??false)("aria-controls",e.overlayVisible?e.id+"_list":null)("aria-activedescendant",e.focused?e.focusedOptionId:void 0);}}function At(n,l){if(n&1){let e=kD();Pu(),Ti(0,"svg",21),gh("click",function(){Du$1(e);let i=HD(2);return wu(i.clear())}),Uc();}if(n&2){let e=HD(2);lw(e.cx("clearIcon")),ch("pBind",e.ptm("clearIcon")),ah("aria-hidden",true);}}function Lt(n,l){}function Ft(n,l){n&1&&rh(0,Lt,0,0,"ng-template");}function Bt(n,l){if(n&1){let e=kD();Ti(0,"span",22),gh("click",function(){Du$1(e);let i=HD(2);return wu(i.clear())}),rh(1,Ft,1,0,null,23),Uc();}if(n&2){let e=HD(2);lw(e.cx("clearIcon")),ch("pBind",e.ptm("clearIcon")),ah("aria-hidden",true),pE(),ch("ngTemplateOutlet",e.clearIconTemplate||e._clearIconTemplate);}}function Dt(n,l){if(n&1&&(Wc(0),rh(1,At,1,4,"svg",19)(2,Bt,2,5,"span",20),zc()),n&2){let e=HD();pE(),ch("ngIf",!e.clearIconTemplate&&!e._clearIconTemplate),pE(),ch("ngIf",e.clearIconTemplate||e._clearIconTemplate);}}function Rt(n,l){n&1&&fh(0);}function Kt(n,l){if(n&1){let e=kD();Ti(0,"span",22),gh("click",function(i){Du$1(e);let o=HD(2).index,a=HD(2);return wu(!a.readonly&&!a.$disabled()?a.removeOption(i,o):"")}),Pu(),lh(1,"svg",31),Uc();}if(n&2){let e=HD(4);lw(e.cx("chipIcon")),ch("pBind",e.ptm("chipIcon")),pE(),lw(e.cx("chipIcon")),ah("aria-hidden",true);}}function zt(n,l){}function $t(n,l){n&1&&rh(0,zt,0,0,"ng-template");}function Nt(n,l){if(n&1&&(Ti(0,"span",32),rh(1,$t,1,0,null,29),Uc()),n&2){let e=HD(2).index,t=HD(2);ch("pBind",t.ptm("chipIcon")),ah("aria-hidden",true),pE(),ch("ngTemplateOutlet",t.removeIconTemplate||t._removeIconTemplate)("ngTemplateOutletContext",Rw(4,Tt,t.removeOption.bind(t),e,t.cx("chipIcon")));}}function Pt(n,l){if(n&1&&rh(0,Kt,2,6,"span",20)(1,Nt,2,8,"span",30),n&2){let e=HD(3);ch("ngIf",!e.removeIconTemplate&&!e._removeIconTemplate),pE(),ch("ngIf",e.removeIconTemplate||e._removeIconTemplate);}}function Qt(n,l){if(n&1){let e=kD();Ti(0,"li",26,5)(2,"p-chip",28),gh("onRemove",function(i){let o=Du$1(e).index,a=HD(2);return wu(a.readonly?"":a.removeOption(i,o))}),rh(3,Rt,1,0,"ng-container",29)(4,Pt,2,2,"ng-template",null,6,qw),Uc()();}if(n&2){let e=l.$implicit,t=l.index,i=HD(2);lw(i.cx("chipItem",xw(17,Ot,t))),ch("pBind",i.ptm("chipItem")),ah("id",i.id+"_multiple_option_"+t)("aria-label",i.getOptionLabel(e))("aria-setsize",i.modelValue().length)("aria-posinset",t+1)("aria-selected",true),pE(2),lw(i.cx("pcChip")),ch("pt",i.ptm("pcChip"))("label",!i.selectedItemTemplate&&!i._selectedItemTemplate&&i.getOptionLabel(e))("disabled",i.$disabled())("removable",true)("unstyled",i.unstyled()),pE(),ch("ngTemplateOutlet",i.selectedItemTemplate||i._selectedItemTemplate)("ngTemplateOutletContext",xw(19,tt,e));}}function Ut(n,l){if(n&1){let e=kD();Ti(0,"ul",24,3),gh("focus",function(i){Du$1(e);let o=HD();return wu(o.onMultipleContainerFocus(i))})("blur",function(i){Du$1(e);let o=HD();return wu(o.onMultipleContainerBlur(i))})("keydown",function(i){Du$1(e);let o=HD();return wu(o.onMultipleContainerKeyDown(i))}),rh(2,Qt,6,21,"li",25),Ti(3,"li",26)(4,"input",27,4),gh("input",function(i){Du$1(e);let o=HD();return wu(o.onInput(i))})("keydown",function(i){Du$1(e);let o=HD();return wu(o.onKeyDown(i))})("change",function(i){Du$1(e);let o=HD();return wu(o.onInputChange(i))})("focus",function(i){Du$1(e);let o=HD();return wu(o.onInputFocus(i))})("blur",function(i){Du$1(e);let o=HD();return wu(o.onInputBlur(i))})("paste",function(i){Du$1(e);let o=HD();return wu(o.onInputPaste(i))})("keyup",function(i){Du$1(e);let o=HD();return wu(o.onInputKeyUp(i))}),Uc()()();}if(n&2){let e=HD();lw(e.cx("inputMultiple")),ch("pBind",e.ptm("inputMultiple"))("tabindex",-1),ah("data-p",e.inputMultipleDataP)("aria-orientation","horizontal")("aria-activedescendant",e.focused?e.focusedMultipleOptionId:void 0),pE(2),ch("ngForOf",e.modelValue()),pE(),lw(e.cx("inputChip")),ch("pBind",e.ptm("inputChip")),pE(),lw(e.cx("pcInputText")),ch("pAutoFocus",e.autofocus)("pBind",e.ptm("input"))("ngStyle",e.inputStyle),ah("type",e.type)("id",e.inputId)("autocomplete",e.autocomplete)("name",e.name())("minlength",e.minlength())("maxlength",e.maxlength())("size",e.size())("min",e.min())("max",e.max())("pattern",e.pattern())("placeholder",e.$filled()?null:e.placeholder)("tabindex",e.$disabled()?-1:e.tabindex)("required",e.required()?"":void 0)("readonly",e.readonly?"":void 0)("disabled",e.$disabled()?"":void 0)("aria-label",e.ariaLabel)("aria-labelledby",e.ariaLabelledBy)("aria-required",e.required())("aria-expanded",e.overlayVisible??false)("aria-controls",e.overlayVisible?e.id+"_list":null)("aria-activedescendant",e.focused?e.focusedOptionId:void 0);}}function qt(n,l){if(n&1&&(Pu(),lh(0,"svg",35)),n&2){let e=HD(2);lw(e.cx("loader")),ch("pBind",e.ptm("loader"))("spin",true),ah("aria-hidden",true);}}function Ht(n,l){}function Gt(n,l){n&1&&rh(0,Ht,0,0,"ng-template");}function jt(n,l){if(n&1&&(Ti(0,"span",32),rh(1,Gt,1,0,null,23),Uc()),n&2){let e=HD(2);lw(e.cx("loader")),ch("pBind",e.ptm("loader")),ah("aria-hidden",true),pE(),ch("ngTemplateOutlet",e.loadingIconTemplate||e._loadingIconTemplate);}}function Wt(n,l){if(n&1&&(Wc(0),rh(1,qt,1,5,"svg",33)(2,jt,2,5,"span",34),zc()),n&2){let e=HD();pE(),ch("ngIf",!e.loadingIconTemplate&&!e._loadingIconTemplate),pE(),ch("ngIf",e.loadingIconTemplate||e._loadingIconTemplate);}}function Zt(n,l){if(n&1&&lh(0,"span",38),n&2){let e=HD(2);ch("ngClass",e.dropdownIcon),ah("aria-hidden",true);}}function Jt(n,l){if(n&1&&(Pu(),lh(0,"svg",40)),n&2){let e=HD(3);ch("pBind",e.ptm("dropdown"));}}function Xt(n,l){}function Yt(n,l){n&1&&rh(0,Xt,0,0,"ng-template");}function en(n,l){if(n&1&&(Wc(0),rh(1,Jt,1,1,"svg",39)(2,Yt,1,0,null,23),zc()),n&2){let e=HD(2);pE(),ch("ngIf",!e.dropdownIconTemplate&&!e._dropdownIconTemplate),pE(),ch("ngTemplateOutlet",e.dropdownIconTemplate||e._dropdownIconTemplate);}}function tn(n,l){if(n&1){let e=kD();Ti(0,"button",36,7),gh("click",function(i){Du$1(e);let o=HD();return wu(o.handleDropdownClick(i))}),rh(2,Zt,1,2,"span",37)(3,en,3,2,"ng-container",14),Uc();}if(n&2){let e=HD();lw(e.cx("dropdown")),ch("pBind",e.ptm("dropdown"))("disabled",e.$disabled()),ah("aria-label",e.dropdownAriaLabel)("tabindex",e.tabindex),pE(2),ch("ngIf",e.dropdownIcon),pE(),ch("ngIf",!e.dropdownIcon);}}function nn(n,l){n&1&&fh(0);}function on(n,l){n&1&&fh(0);}function ln(n,l){if(n&1&&rh(0,on,1,0,"ng-container",29),n&2){let e=l.$implicit,t=l.options;HD(2);let i=QD(6);ch("ngTemplateOutlet",i)("ngTemplateOutletContext",Aw(2,nt,e,t));}}function an(n,l){n&1&&fh(0);}function rn(n,l){if(n&1&&rh(0,an,1,0,"ng-container",29),n&2){let e=l.options,t=HD(4);ch("ngTemplateOutlet",t.loaderTemplate||t._loaderTemplate)("ngTemplateOutletContext",xw(2,St,e));}}function pn(n,l){n&1&&(Wc(0),rh(1,rn,1,4,"ng-template",null,10,qw),zc());}function sn(n,l){if(n&1){let e=kD();Ti(0,"p-scroller",45,9),gh("onLazyLoad",function(i){Du$1(e);let o=HD(2);return wu(o.onLazyLoad.emit(i))}),rh(2,ln,1,5,"ng-template",null,1,qw)(4,pn,3,0,"ng-container",14),Uc();}if(n&2){let e=HD(2);aw(xw(10,le,e.scrollHeight)),ch("tabindex",-1)("pt",e.ptm("virtualScroller"))("items",e.visibleOptions())("itemSize",e.virtualScrollItemSize)("autoSize",true)("lazy",e.lazy)("options",e.virtualScrollOptions),pE(4),ch("ngIf",e.loaderTemplate||e._loaderTemplate);}}function cn(n,l){n&1&&fh(0);}function un(n,l){if(n&1&&(Wc(0),rh(1,cn,1,0,"ng-container",29),zc()),n&2){HD();let e=QD(6),t=HD();pE(),ch("ngTemplateOutlet",e)("ngTemplateOutletContext",Aw(3,nt,t.visibleOptions(),Sw(2,Et)));}}function dn(n,l){if(n&1&&(Ti(0,"span"),Ew(1),Uc()),n&2){let e=HD(2).$implicit,t=HD(3);pE(),Oh(t.getOptionGroupLabel(e.optionGroup));}}function mn(n,l){n&1&&fh(0);}function hn(n,l){if(n&1&&(Wc(0),Ti(1,"li",49),rh(2,dn,2,1,"span",14)(3,mn,1,0,"ng-container",29),Uc(),zc()),n&2){let e=HD(),t=e.$implicit,i=e.index,o=HD().options,a=HD(2);pE(),lw(a.cx("optionGroup")),ch("pBind",a.ptm("optionGroup"))("ngStyle",xw(8,le,o.itemSize+"px")),ah("id",a.id+"_"+a.getOptionIndex(i,o)),pE(),ch("ngIf",!a.groupTemplate),pE(),ch("ngTemplateOutlet",a.groupTemplate)("ngTemplateOutletContext",xw(10,tt,t.optionGroup));}}function _n(n,l){if(n&1&&(Ti(0,"span"),Ew(1),Uc()),n&2){let e=HD(2).$implicit,t=HD(3);pE(),Oh(t.getOptionLabel(e));}}function gn(n,l){n&1&&fh(0);}function fn(n,l){if(n&1){let e=kD();Wc(0),Ti(1,"li",50),gh("click",function(i){Du$1(e);let o=HD().$implicit,a=HD(3);return wu(a.onOptionSelect(i,o))})("mouseenter",function(i){Du$1(e);let o=HD().index,a=HD().options,y=HD(2);return wu(y.onOptionMouseEnter(i,y.getOptionIndex(o,a)))}),rh(2,_n,2,1,"span",14)(3,gn,1,0,"ng-container",29),Uc(),zc();}if(n&2){let e=HD(),t=e.$implicit,i=e.index,o=HD().options,a=HD(2);pE(),lw(a.cx("option",Rw(15,Vt,t,i,o))),ch("pBind",a.getPTOptions(t,o,i,"option"))("ngStyle",xw(19,le,o.itemSize+"px")),ah("id",a.id+"_"+a.getOptionIndex(i,o))("aria-label",a.getOptionLabel(t))("aria-selected",a.isSelected(t))("data-p-selected",a.isSelected(t))("aria-disabled",a.isOptionDisabled(t))("data-p-focused",a.focusedOptionIndex()===a.getOptionIndex(i,o))("aria-setsize",a.ariaSetSize)("aria-posinset",a.getAriaPosInset(a.getOptionIndex(i,o))),pE(),ch("ngIf",!a.itemTemplate&&!a._itemTemplate),pE(),ch("ngTemplateOutlet",a.itemTemplate||a._itemTemplate)("ngTemplateOutletContext",Aw(21,kt,t,o.getOptions?o.getOptions(i):i));}}function yn(n,l){if(n&1&&rh(0,hn,4,12,"ng-container",14)(1,fn,4,24,"ng-container",14),n&2){let e=l.$implicit,t=HD(3);ch("ngIf",t.isOptionGroup(e)),pE(),ch("ngIf",!t.isOptionGroup(e));}}function xn(n,l){if(n&1&&(Wc(0),Ew(1),zc()),n&2){let e=HD(4);pE(),Qc(" ",e.searchResultMessageText," ");}}function bn(n,l){n&1&&fh(0,null,12);}function vn(n,l){if(n&1&&(Ti(0,"li",49),rh(1,xn,2,1,"ng-container",51)(2,bn,2,0,"ng-container",23),Uc()),n&2){let e=HD().options,t=HD(2);lw(t.cx("emptyMessage")),ch("pBind",t.ptm("emptyMessage"))("ngStyle",xw(7,le,e.itemSize+"px")),pE(),ch("ngIf",!t.emptyTemplate&&!t._emptyTemplate)("ngIfElse",t.empty),pE(),ch("ngTemplateOutlet",t.emptyTemplate||t._emptyTemplate);}}function In(n,l){if(n&1&&(Ti(0,"ul",46,11),rh(2,yn,2,2,"ng-template",47)(3,vn,3,9,"li",48),Uc()),n&2){let e=l.$implicit,t=l.options,i=HD(2);aw(t.contentStyle),lw(i.cn(i.cx("list"),t.contentStyleClass)),ch("pBind",i.ptm("list")),ah("id",i.id+"_list")("aria-label",i.listLabel),pE(2),ch("ngForOf",e),pE(),ch("ngIf",!e||e&&e.length===0&&i.showEmptyMessage);}}function wn(n,l){n&1&&fh(0);}function Cn(n,l){if(n&1&&(Ti(0,"div",41),rh(1,nn,1,0,"ng-container",23),Ti(2,"div",42),rh(3,sn,5,12,"p-scroller",43)(4,un,2,6,"ng-container",14),Uc(),rh(5,In,4,9,"ng-template",null,8,qw)(7,wn,1,0,"ng-container",23),Uc(),Ti(8,"span",44),Ew(9),Uc()),n&2){let e=HD();lw(e.cn(e.cx("overlay"),e.panelStyleClass)),ch("pBind",e.ptm("overlay"))("ngStyle",e.panelStyle),pE(),ch("ngTemplateOutlet",e.headerTemplate||e._headerTemplate),pE(),lw(e.cx("listContainer")),Ch("max-height",e.virtualScroll?"auto":e.scrollHeight),ch("pBind",e.ptm("listContainer"))("tabindex",-1),pE(),ch("ngIf",e.virtualScroll),pE(),ch("ngIf",!e.virtualScroll),pE(3),ch("ngTemplateOutlet",e.footerTemplate||e._footerTemplate),pE(2),Qc(" ",e.selectedMessageText," ");}}var On=`
${Xe}
