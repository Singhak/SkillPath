import {R as Re}from'./chunk-XGLGt3LD.js';import {aa as KI,ab as bs,ac as el,ad as hr,I,ax as C,ae as Hc,ao as py,Z as ZI,c as cn$1,au as rh,aP as Lu,T as Ti,d as dh,U as Uc,C as fw,A as _h,u as uh,l as gE,aK as lh,a3 as Aw,ay as wo,az as iD,aG as NL,af as Le,H as Ho,K as Kw,bj as Qe,by as Le$1,an as tl,aO as Bi$1,bz as cu,bA as Nt$1,bu as Au,bB as ws,bo as wu,bc as Rr,bC as Zu,ah as ae,a as as,ap as Ci,aq as us,ar as cs,as as ls,aH as ce,bD as re,bE as L,bF as de,at as Ue,bf as Wc,av as OL,aw as PL,o as LD,k as ih,h as Hh,p as wu$1,B as bw,s as Tu,f as yh,V as Vh,aX as uw,aA as Ih,aB as QD,aC as ZD,aD as Eh,Q as Qu,bG as n,ai as qi,bH as xn$1,aF as ve,e as ee,n as UD,b0 as Wc$1,b1 as zc,b as ww,v as Qc,bh as Do,aZ as zw,aY as kw,b2 as hh,a$ as KD,be as Ow,R as Rw,b5 as Pw,L as Lh}from'./main-PV6KZ257.js';import {d as dt$1,U as Ut$1}from'./chunk-BaWgWCdN.js';import {T as Tt$1,W as Wt$1,m as mt$1}from'./chunk-BpwZNG_E.js';import {p as pe}from'./chunk-BAqlJeyf.js';var Ge=`
    .p-progressspinner {
        position: relative;
        margin: 0 auto;
        width: 100px;
...
`;var lt={root:()=>["p-progressspinner"],spin:"p-progressspinner-spin",circle:"p-progressspinner-circle"},je=(()=>{class n extends ve{name="progressspinner";style=Ge;classes=lt;static \u0275fac=(()=>{let e;return function(i){return (e||(e=py(n)))(i||n)}})();static \u0275prov=ee({token:n,factory:n.\u0275fac})}return n})();var We=new C("PROGRESSSPINNER_INSTANCE"),at=(()=>{class n extends hr{componentName="ProgressSpinner";$pcProgressSpinner=I(We,{optional:true,skipSelf:true})??void 0;bindDirectiveInstance=I(Hc,{self:true});styleClass;strokeWidth="2";fill="none";animationDuration="2s";ariaLabel;onAfterViewChecked(){this.bindDirectiveInstance.setAttrs(this.ptms(["host","root"]));}_componentStyle=I(je);static \u0275fac=(()=>{let e;return function(i){return (e||(e=py(n)))(i||n)}})();static \u0275cmp=ZI({type:n,selectors:[["p-progressSpinner"],["p-progress-spinner"],["p-progressspinner"]],hostVars:5,hostBindings:function(t,i){t&2&&(lh("aria-label",i.ariaLabel)("role","progressbar")("aria-busy",true),fw(i.cn(i.cx("root"),i.styleClass)));},inputs:{styleClass:"styleClass",strokeWidth:"strokeWidth",fill:"fill",animationDuration:"animationDuration",ariaLabel:"ariaLabel"},features:[Aw([je,{provide:We,useExisting:n},{provide:wo,useExisting:n}]),iD([Hc]),rh],decls:2,vars:10,consts:[["viewBox","25 25 50 50",3,"pBind"],["cx","50","cy","50","r","20","stroke-miterlimit","10",3,"pBind"]],template:function(t,i){t&1&&(Lu(),Ti(0,"svg",0),dh(1,"circle",1),Uc()),t&2&&(fw(i.cx("spin")),_h("animation-duration",i.animationDuration),uh("pBind",i.ptm("spin")),gE(),fw(i.cx("circle")),uh("pBind",i.ptm("circle")),lh("fill",i.fill)("stroke-width",i.strokeWidth));},dependencies:[cn$1,el,Hc],encapsulation:2})}return n})(),Qn=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=KI({type:n});static \u0275inj=bs({imports:[at,el,el]})}return n})();var Je=class n$1{apiUrl=`${n.apiUrl}`;http=I(qi);generateEvaluation(l){return this.http.post(`${this.apiUrl}/ai-evaluations`,l)}generateMockEvaluation(l){return this.http.post(`${this.apiUrl}/ai-evaluations/mock-evaluation`,l)}genrateFromTopic(l,e,t,i){return this.http.post(`${this.apiUrl}/ai-question-sets/from-topic`,{topic:l,userRole:e,experienceLevel:t,questionCount:i})}generateFromJobDescription(l,e,t,i){return this.http.post(`${this.apiUrl}/ai-question-sets/from-job-description`,{jobDescription:l,userRole:e,experienceLevel:t,questionCount:i})}getAiGeneratedQuestion(l,e){return this.http.get(`${this.apiUrl}/ai-questions`,{params:{type:l,level:e}})}static \u0275fac=function(e){return new(e||n$1)};static \u0275prov=xn$1({token:n$1,factory:n$1.\u0275fac})};var Zn=["Frontend Developer","Backend Developer","Full-Stack Developer","Mobile Developer","Software Architect","UI/UX Designer","Project Manager","Scrum Master","Product Owner","QA Engineer","DevOps Engineer","Support Engineer","Security Engineer","Data Engineer","ML/AI Engineer"],Jn=["Intern","Junior","Mid-Level","Senior","Lead","Principal","Architect"],Xn=["Explain concepts clearly","Give practical examples","Mention trade-offs","Speak confidently"],Yn=["Extract Required Skills","Generate Technical Questions","Behavioral Questions","Coding Questions","Difficulty Detection"];function ei(n,l){let e=document.createElement("a");return e.setAttribute("href",n),e.setAttribute("download",l),document.body.appendChild(e),e}function ti(n){switch(n=n?.toLowerCase()?.trim(),n){case "basic":return 1;case "intermediate":return 1.5;case "advanced":return 2;case "critical concept":return 3;default:return ""}}var ni={QUESTION_EVALUATION:.25};var Xe=`
    .p-autocomplete {
        display: inline-flex;
    }
...
`;var rt=["item"],pt=["empty"],st=["header"],ct=["footer"],ut=["selecteditem"],dt=["group"],mt=["loader"],ht=["removeicon"],_t=["loadingicon"],gt=["clearicon"],ft=["dropdownicon"],yt=["focusInput"],xt=["multiIn"],bt=["multiContainer"],vt=["ddBtn"],It=["items"],wt=["scroller"],Ct=["overlay"],Ot=n=>({i:n}),tt=n=>({$implicit:n}),Tt=(n,l,e)=>({removeCallback:n,index:l,class:e}),le=n=>({height:n}),nt=(n,l)=>({$implicit:n,options:l}),St=n=>({options:n}),Et=()=>({}),Vt=(n,l,e)=>({option:n,i:l,scrollerOptions:e}),kt=(n,l)=>({$implicit:n,index:l});function Mt(n,l){if(n&1){let e=LD();Ti(0,"input",18,2),yh("input",function(i){wu$1(e);let o=UD();return Tu(o.onInput(i))})("keydown",function(i){wu$1(e);let o=UD();return Tu(o.onKeyDown(i))})("change",function(i){wu$1(e);let o=UD();return Tu(o.onInputChange(i))})("focus",function(i){wu$1(e);let o=UD();return Tu(o.onInputFocus(i))})("blur",function(i){wu$1(e);let o=UD();return Tu(o.onInputBlur(i))})("paste",function(i){wu$1(e);let o=UD();return Tu(o.onInputPaste(i))})("keyup",function(i){wu$1(e);let o=UD();return Tu(o.onInputKeyUp(i))}),Uc();}if(n&2){let e=UD();fw(e.cn(e.cx("pcInputText"),e.inputStyleClass)),uh("pAutoFocus",e.autofocus)("pt",e.ptm("pcInputText"))("ngStyle",e.inputStyle)("variant",e.$variant())("invalid",e.invalid())("pSize",e.size())("fluid",e.hasFluid)("pInputTextUnstyled",e.unstyled()),lh("type",e.type)("value",e.inputValue())("id",e.inputId)("autocomplete",e.autocomplete)("placeholder",e.placeholder)("name",e.name())("minlength",e.minlength())("min",e.min())("max",e.max())("pattern",e.pattern())("size",e.inputSize())("maxlength",e.maxlength())("tabindex",e.$disabled()?-1:e.tabindex)("required",e.required()?"":void 0)("readonly",e.readonly?"":void 0)("disabled",e.$disabled()?"":void 0)("aria-label",e.ariaLabel)("aria-labelledby",e.ariaLabelledBy)("aria-required",e.required())("aria-expanded",e.overlayVisible??false)("aria-controls",e.overlayVisible?e.id+"_list":null)("aria-activedescendant",e.focused?e.focusedOptionId:void 0);}}function At(n,l){if(n&1){let e=LD();Lu(),Ti(0,"svg",21),yh("click",function(){wu$1(e);let i=UD(2);return Tu(i.clear())}),Uc();}if(n&2){let e=UD(2);fw(e.cx("clearIcon")),uh("pBind",e.ptm("clearIcon")),lh("aria-hidden",true);}}function Lt(n,l){}function Ft(n,l){n&1&&ih(0,Lt,0,0,"ng-template");}function Bt(n,l){if(n&1){let e=LD();Ti(0,"span",22),yh("click",function(){wu$1(e);let i=UD(2);return Tu(i.clear())}),ih(1,Ft,1,0,null,23),Uc();}if(n&2){let e=UD(2);fw(e.cx("clearIcon")),uh("pBind",e.ptm("clearIcon")),lh("aria-hidden",true),gE(),uh("ngTemplateOutlet",e.clearIconTemplate||e._clearIconTemplate);}}function Dt(n,l){if(n&1&&(Wc$1(0),ih(1,At,1,4,"svg",19)(2,Bt,2,5,"span",20),zc()),n&2){let e=UD();gE(),uh("ngIf",!e.clearIconTemplate&&!e._clearIconTemplate),gE(),uh("ngIf",e.clearIconTemplate||e._clearIconTemplate);}}function Rt(n,l){n&1&&hh(0);}function Kt(n,l){if(n&1){let e=LD();Ti(0,"span",22),yh("click",function(i){wu$1(e);let o=UD(2).index,a=UD(2);return Tu(!a.readonly&&!a.$disabled()?a.removeOption(i,o):"")}),Lu(),dh(1,"svg",31),Uc();}if(n&2){let e=UD(4);fw(e.cx("chipIcon")),uh("pBind",e.ptm("chipIcon")),gE(),fw(e.cx("chipIcon")),lh("aria-hidden",true);}}function zt(n,l){}function $t(n,l){n&1&&ih(0,zt,0,0,"ng-template");}function Nt(n,l){if(n&1&&(Ti(0,"span",32),ih(1,$t,1,0,null,29),Uc()),n&2){let e=UD(2).index,t=UD(2);uh("pBind",t.ptm("chipIcon")),lh("aria-hidden",true),gE(),uh("ngTemplateOutlet",t.removeIconTemplate||t._removeIconTemplate)("ngTemplateOutletContext",Pw(4,Tt,t.removeOption.bind(t),e,t.cx("chipIcon")));}}function Pt(n,l){if(n&1&&ih(0,Kt,2,6,"span",20)(1,Nt,2,8,"span",30),n&2){let e=UD(3);uh("ngIf",!e.removeIconTemplate&&!e._removeIconTemplate),gE(),uh("ngIf",e.removeIconTemplate||e._removeIconTemplate);}}function Qt(n,l){if(n&1){let e=LD();Ti(0,"li",26,5)(2,"p-chip",28),yh("onRemove",function(i){let o=wu$1(e).index,a=UD(2);return Tu(a.readonly?"":a.removeOption(i,o))}),ih(3,Rt,1,0,"ng-container",29)(4,Pt,2,2,"ng-template",null,6,zw),Uc()();}if(n&2){let e=l.$implicit,t=l.index,i=UD(2);fw(i.cx("chipItem",kw(17,Ot,t))),uh("pBind",i.ptm("chipItem")),lh("id",i.id+"_multiple_option_"+t)("aria-label",i.getOptionLabel(e))("aria-setsize",i.modelValue().length)("aria-posinset",t+1)("aria-selected",true),gE(2),fw(i.cx("pcChip")),uh("pt",i.ptm("pcChip"))("label",!i.selectedItemTemplate&&!i._selectedItemTemplate&&i.getOptionLabel(e))("disabled",i.$disabled())("removable",true)("unstyled",i.unstyled()),gE(),uh("ngTemplateOutlet",i.selectedItemTemplate||i._selectedItemTemplate)("ngTemplateOutletContext",kw(19,tt,e));}}function Ut(n,l){if(n&1){let e=LD();Ti(0,"ul",24,3),yh("focus",function(i){wu$1(e);let o=UD();return Tu(o.onMultipleContainerFocus(i))})("blur",function(i){wu$1(e);let o=UD();return Tu(o.onMultipleContainerBlur(i))})("keydown",function(i){wu$1(e);let o=UD();return Tu(o.onMultipleContainerKeyDown(i))}),ih(2,Qt,6,21,"li",25),Ti(3,"li",26)(4,"input",27,4),yh("input",function(i){wu$1(e);let o=UD();return Tu(o.onInput(i))})("keydown",function(i){wu$1(e);let o=UD();return Tu(o.onKeyDown(i))})("change",function(i){wu$1(e);let o=UD();return Tu(o.onInputChange(i))})("focus",function(i){wu$1(e);let o=UD();return Tu(o.onInputFocus(i))})("blur",function(i){wu$1(e);let o=UD();return Tu(o.onInputBlur(i))})("paste",function(i){wu$1(e);let o=UD();return Tu(o.onInputPaste(i))})("keyup",function(i){wu$1(e);let o=UD();return Tu(o.onInputKeyUp(i))}),Uc()()();}if(n&2){let e=UD();fw(e.cx("inputMultiple")),uh("pBind",e.ptm("inputMultiple"))("tabindex",-1),lh("data-p",e.inputMultipleDataP)("aria-orientation","horizontal")("aria-activedescendant",e.focused?e.focusedMultipleOptionId:void 0),gE(2),uh("ngForOf",e.modelValue()),gE(),fw(e.cx("inputChip")),uh("pBind",e.ptm("inputChip")),gE(),fw(e.cx("pcInputText")),uh("pAutoFocus",e.autofocus)("pBind",e.ptm("input"))("ngStyle",e.inputStyle),lh("type",e.type)("id",e.inputId)("autocomplete",e.autocomplete)("name",e.name())("minlength",e.minlength())("maxlength",e.maxlength())("size",e.size())("min",e.min())("max",e.max())("pattern",e.pattern())("placeholder",e.$filled()?null:e.placeholder)("tabindex",e.$disabled()?-1:e.tabindex)("required",e.required()?"":void 0)("readonly",e.readonly?"":void 0)("disabled",e.$disabled()?"":void 0)("aria-label",e.ariaLabel)("aria-labelledby",e.ariaLabelledBy)("aria-required",e.required())("aria-expanded",e.overlayVisible??false)("aria-controls",e.overlayVisible?e.id+"_list":null)("aria-activedescendant",e.focused?e.focusedOptionId:void 0);}}function qt(n,l){if(n&1&&(Lu(),dh(0,"svg",35)),n&2){let e=UD(2);fw(e.cx("loader")),uh("pBind",e.ptm("loader"))("spin",true),lh("aria-hidden",true);}}function Ht(n,l){}function Gt(n,l){n&1&&ih(0,Ht,0,0,"ng-template");}function jt(n,l){if(n&1&&(Ti(0,"span",32),ih(1,Gt,1,0,null,23),Uc()),n&2){let e=UD(2);fw(e.cx("loader")),uh("pBind",e.ptm("loader")),lh("aria-hidden",true),gE(),uh("ngTemplateOutlet",e.loadingIconTemplate||e._loadingIconTemplate);}}function Wt(n,l){if(n&1&&(Wc$1(0),ih(1,qt,1,5,"svg",33)(2,jt,2,5,"span",34),zc()),n&2){let e=UD();gE(),uh("ngIf",!e.loadingIconTemplate&&!e._loadingIconTemplate),gE(),uh("ngIf",e.loadingIconTemplate||e._loadingIconTemplate);}}function Zt(n,l){if(n&1&&dh(0,"span",38),n&2){let e=UD(2);uh("ngClass",e.dropdownIcon),lh("aria-hidden",true);}}function Jt(n,l){if(n&1&&(Lu(),dh(0,"svg",40)),n&2){let e=UD(3);uh("pBind",e.ptm("dropdown"));}}function Xt(n,l){}function Yt(n,l){n&1&&ih(0,Xt,0,0,"ng-template");}function en(n,l){if(n&1&&(Wc$1(0),ih(1,Jt,1,1,"svg",39)(2,Yt,1,0,null,23),zc()),n&2){let e=UD(2);gE(),uh("ngIf",!e.dropdownIconTemplate&&!e._dropdownIconTemplate),gE(),uh("ngTemplateOutlet",e.dropdownIconTemplate||e._dropdownIconTemplate);}}function tn(n,l){if(n&1){let e=LD();Ti(0,"button",36,7),yh("click",function(i){wu$1(e);let o=UD();return Tu(o.handleDropdownClick(i))}),ih(2,Zt,1,2,"span",37)(3,en,3,2,"ng-container",14),Uc();}if(n&2){let e=UD();fw(e.cx("dropdown")),uh("pBind",e.ptm("dropdown"))("disabled",e.$disabled()),lh("aria-label",e.dropdownAriaLabel)("tabindex",e.tabindex),gE(2),uh("ngIf",e.dropdownIcon),gE(),uh("ngIf",!e.dropdownIcon);}}function nn(n,l){n&1&&hh(0);}function on(n,l){n&1&&hh(0);}function ln(n,l){if(n&1&&ih(0,on,1,0,"ng-container",29),n&2){let e=l.$implicit,t=l.options;UD(2);let i=KD(6);uh("ngTemplateOutlet",i)("ngTemplateOutletContext",Ow(2,nt,e,t));}}function an(n,l){n&1&&hh(0);}function rn(n,l){if(n&1&&ih(0,an,1,0,"ng-container",29),n&2){let e=l.options,t=UD(4);uh("ngTemplateOutlet",t.loaderTemplate||t._loaderTemplate)("ngTemplateOutletContext",kw(2,St,e));}}function pn(n,l){n&1&&(Wc$1(0),ih(1,rn,1,4,"ng-template",null,10,zw),zc());}function sn(n,l){if(n&1){let e=LD();Ti(0,"p-scroller",45,9),yh("onLazyLoad",function(i){wu$1(e);let o=UD(2);return Tu(o.onLazyLoad.emit(i))}),ih(2,ln,1,5,"ng-template",null,1,zw)(4,pn,3,0,"ng-container",14),Uc();}if(n&2){let e=UD(2);uw(kw(10,le,e.scrollHeight)),uh("tabindex",-1)("pt",e.ptm("virtualScroller"))("items",e.visibleOptions())("itemSize",e.virtualScrollItemSize)("autoSize",true)("lazy",e.lazy)("options",e.virtualScrollOptions),gE(4),uh("ngIf",e.loaderTemplate||e._loaderTemplate);}}function cn(n,l){n&1&&hh(0);}function un(n,l){if(n&1&&(Wc$1(0),ih(1,cn,1,0,"ng-container",29),zc()),n&2){UD();let e=KD(6),t=UD();gE(),uh("ngTemplateOutlet",e)("ngTemplateOutletContext",Ow(3,nt,t.visibleOptions(),Rw(2,Et)));}}function dn(n,l){if(n&1&&(Ti(0,"span"),ww(1),Uc()),n&2){let e=UD(2).$implicit,t=UD(3);gE(),Lh(t.getOptionGroupLabel(e.optionGroup));}}function mn(n,l){n&1&&hh(0);}function hn(n,l){if(n&1&&(Wc$1(0),Ti(1,"li",49),ih(2,dn,2,1,"span",14)(3,mn,1,0,"ng-container",29),Uc(),zc()),n&2){let e=UD(),t=e.$implicit,i=e.index,o=UD().options,a=UD(2);gE(),fw(a.cx("optionGroup")),uh("pBind",a.ptm("optionGroup"))("ngStyle",kw(8,le,o.itemSize+"px")),lh("id",a.id+"_"+a.getOptionIndex(i,o)),gE(),uh("ngIf",!a.groupTemplate),gE(),uh("ngTemplateOutlet",a.groupTemplate)("ngTemplateOutletContext",kw(10,tt,t.optionGroup));}}function _n(n,l){if(n&1&&(Ti(0,"span"),ww(1),Uc()),n&2){let e=UD(2).$implicit,t=UD(3);gE(),Lh(t.getOptionLabel(e));}}function gn(n,l){n&1&&hh(0);}function fn(n,l){if(n&1){let e=LD();Wc$1(0),Ti(1,"li",50),yh("click",function(i){wu$1(e);let o=UD().$implicit,a=UD(3);return Tu(a.onOptionSelect(i,o))})("mouseenter",function(i){wu$1(e);let o=UD().index,a=UD().options,y=UD(2);return Tu(y.onOptionMouseEnter(i,y.getOptionIndex(o,a)))}),ih(2,_n,2,1,"span",14)(3,gn,1,0,"ng-container",29),Uc(),zc();}if(n&2){let e=UD(),t=e.$implicit,i=e.index,o=UD().options,a=UD(2);gE(),fw(a.cx("option",Pw(15,Vt,t,i,o))),uh("pBind",a.getPTOptions(t,o,i,"option"))("ngStyle",kw(19,le,o.itemSize+"px")),lh("id",a.id+"_"+a.getOptionIndex(i,o))("aria-label",a.getOptionLabel(t))("aria-selected",a.isSelected(t))("data-p-selected",a.isSelected(t))("aria-disabled",a.isOptionDisabled(t))("data-p-focused",a.focusedOptionIndex()===a.getOptionIndex(i,o))("aria-setsize",a.ariaSetSize)("aria-posinset",a.getAriaPosInset(a.getOptionIndex(i,o))),gE(),uh("ngIf",!a.itemTemplate&&!a._itemTemplate),gE(),uh("ngTemplateOutlet",a.itemTemplate||a._itemTemplate)("ngTemplateOutletContext",Ow(21,kt,t,o.getOptions?o.getOptions(i):i));}}function yn(n,l){if(n&1&&ih(0,hn,4,12,"ng-container",14)(1,fn,4,24,"ng-container",14),n&2){let e=l.$implicit,t=UD(3);uh("ngIf",t.isOptionGroup(e)),gE(),uh("ngIf",!t.isOptionGroup(e));}}function xn(n,l){if(n&1&&(Wc$1(0),ww(1),zc()),n&2){let e=UD(4);gE(),Qc(" ",e.searchResultMessageText," ");}}function bn(n,l){n&1&&hh(0,null,12);}function vn(n,l){if(n&1&&(Ti(0,"li",49),ih(1,xn,2,1,"ng-container",51)(2,bn,2,0,"ng-container",23),Uc()),n&2){let e=UD().options,t=UD(2);fw(t.cx("emptyMessage")),uh("pBind",t.ptm("emptyMessage"))("ngStyle",kw(7,le,e.itemSize+"px")),gE(),uh("ngIf",!t.emptyTemplate&&!t._emptyTemplate)("ngIfElse",t.empty),gE(),uh("ngTemplateOutlet",t.emptyTemplate||t._emptyTemplate);}}function In(n,l){if(n&1&&(Ti(0,"ul",46,11),ih(2,yn,2,2,"ng-template",47)(3,vn,3,9,"li",48),Uc()),n&2){let e=l.$implicit,t=l.options,i=UD(2);uw(t.contentStyle),fw(i.cn(i.cx("list"),t.contentStyleClass)),uh("pBind",i.ptm("list")),lh("id",i.id+"_list")("aria-label",i.listLabel),gE(2),uh("ngForOf",e),gE(),uh("ngIf",!e||e&&e.length===0&&i.showEmptyMessage);}}function wn(n,l){n&1&&hh(0);}function Cn(n,l){if(n&1&&(Ti(0,"div",41),ih(1,nn,1,0,"ng-container",23),Ti(2,"div",42),ih(3,sn,5,12,"p-scroller",43)(4,un,2,6,"ng-container",14),Uc(),ih(5,In,4,9,"ng-template",null,8,zw)(7,wn,1,0,"ng-container",23),Uc(),Ti(8,"span",44),ww(9),Uc()),n&2){let e=UD();fw(e.cn(e.cx("overlay"),e.panelStyleClass)),uh("pBind",e.ptm("overlay"))("ngStyle",e.panelStyle),gE(),uh("ngTemplateOutlet",e.headerTemplate||e._headerTemplate),gE(),fw(e.cx("listContainer")),_h("max-height",e.virtualScroll?"auto":e.scrollHeight),uh("pBind",e.ptm("listContainer"))("tabindex",-1),gE(),uh("ngIf",e.virtualScroll),gE(),uh("ngIf",!e.virtualScroll),gE(3),uh("ngTemplateOutlet",e.footerTemplate||e._footerTemplate),gE(2),Qc(" ",e.selectedMessageText," ");}}var On=`
${Xe}
