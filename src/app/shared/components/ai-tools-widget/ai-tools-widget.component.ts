...
@Component({
  ...
  template: `
    <div class="ai-tools-widget bg-slate-900/90 rounded-2xl p-6 border border-slate-800 shadow-xl mb-6 text-white">
      ...
      <div *ngIf="activeTab() === 'resume'" class="animate-fadeIn">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div class="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-5">
            <div class="text-xs font-bold text-indigo-400 uppercase tracking-wider mb-3 flex items-center justify-between">
              ...
              <span *ngIf="resumeService.parsedResume()" class="text-emerald-400 font-semibold">✓ Auto-Synced to Profile</span>
            </div>

            <div *ngIf="!resumeService.parsedResume()" class="py-12 text-center text-slate-500 text-xs">
              Upload a resume file on the left to extract detected skills & target roles.
            </div>

            <div *ngIf="resumeService.parsedResume() as res" class="space-y-4 animate-fadeIn">
              <div>
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-1.5">
                  <span
                    *ngFor="let s of res.extractedSkills"
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-1.5">
                  <span
                    *ngFor="let role of res.suggestedRoles"
      ...
      <div *ngIf="activeTab() === 'speech'" class="animate-fadeIn">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-1 bg-slate-800/40 border border-slate-700/50 rounded-2xl p-5 flex flex-col justify-between">
            <div>
              ...
              <div class="bg-slate-900 p-4 rounded-xl border border-slate-800 min-h-[100px] mb-4 text-xs font-mono text-slate-300">
                <span *ngIf="speechService.isRecording()" class="text-rose-400 animate-pulse font-bold block mb-1">🔴 Recording live audio...</span>
            ...
            <div class="space-y-2">
              <button
                *ngIf="!speechService.isRecording()"
          ...
          <div class="lg:col-span-2">
            <div *ngIf="!speechService.speechMetrics()" class="bg-slate-800/20 border border-slate-800 rounded-2xl p-12 text-center text-slate-500 text-xs">
              Start the speech test to calculate WPM, filler word count, and tone confidence score.
            </div>

            <div *ngIf="speechService.speechMetrics() as m" class="space-y-4 animate-fadeIn">
              <!-- Score Cards Grid -->
      ...
      <div *ngIf="activeTab() === 'star'" class="animate-fadeIn">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div class="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-5">
            ...
            <div *ngIf="!starCoachService.latestEvaluation()" class="py-12 text-center text-slate-500 text-xs">
              Type your answer response on the left and click "Grade Response".
            </div>

            <div *ngIf="starCoachService.latestEvaluation() as eval" class="space-y-3 animate-fadeIn">
